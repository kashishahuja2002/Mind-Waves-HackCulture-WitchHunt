# Mind Waves  - Health & Well-Being

## Submission for WitchHunt hackathon by HackCulture 
...
* Open terminal in a new folder and enter the command given below.
   ```
   git clone https://github.com/kashishahuja2002/Mind-Waves-HackCulture-WitchHunt.git
   ```
